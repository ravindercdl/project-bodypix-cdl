...
class Callback:
    ...
    def generate_svg(self, poses, inference_box, text):
        ...
        svg.write(SVG_TEXT.format(x=70, y='1em', clazz='counter', text=text))
    ...
    def aggregate_buffers(self, inf_buf, inf_caps, vid_buf, vid_caps, box):
        ...
        with self.trash_lock:
            ...
            vid_buf = None
        text = 'Compass Digital - Connected Cafe: {:.2f} FPS,  Time: {:.2f}, Current occupancy: {:d}'.format(1000 / frame_time, now_time, len(poses))
